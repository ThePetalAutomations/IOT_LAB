/*
  ...
  Description:
  • After uploading the code open the serial monitor there will be soft IP address and put it mobile 
  chrome page.
  • Then web server will be open when you press the toggle button from the web server page and 
   LED’s will works
  PINOUTS:
  LED1= GPIO26
  LED2= GPIO27
...
int addr_wifi_ssid = 0;
int addr_wifi_password = 50;
